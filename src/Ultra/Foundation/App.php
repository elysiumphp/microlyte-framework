...
use Ultra\Interfaces\Config\ConfigInterface;
use Ultra\Interfaces\Providers\ServiceProviderInterface;
use DI\Container;
...
class App
{
    ...
    public function __construct(ContainerInterface $containerinterface)
    {
        ...
        $this->slimApp = new SlimApp((new ResponseFactory()), (new $containerinterface($this->setContainer())));
